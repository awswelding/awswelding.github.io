...
function tectxon_circle_progress_counter(){jQuery('.tm-circle-box').each(function(){var circle_box=jQuery(this);var fill_val=circle_box.data('fill');var emptyFill_val=circle_box.data('emptyfill');var thickness_val=circle_box.data('thickness');var fill_gradient=circle_box.data('gradient');var startangle_val=(-Math.PI/4*1.5);if(fill_gradient!=''){fill_gradient=fill_gradient.split('|');fill_val={gradient:[fill_gradient[0],fill_gradient[1]]}}
...
jQuery('.menu-toggle').on('click.tectxon',function(){nav.toggleClass('toggled-on')})})();jQuery('.righticon').each(function(){var mainele=this;if(jQuery(mainele).prev().prev().length>0){if(jQuery(mainele).prev().prev().attr('href')=='#'){jQuery(mainele).prev().prev().on('click',function(){jQuery(mainele).trigger("click")})}}});themetechmount_blogmasonry();jQuery(".themetechmount-fbar-content-wrapper").perfectScrollbar({suppressScrollX:!0,includePadding:!0});jQuery(".tm-header-style-classic-vertical .tm-header-block").perfectScrollbar({suppressScrollX:!0,includePadding:!0})});var tm_bgcolor_class=function(){var section_idd='';jQuery('.elementor-section').each(function(){if(jQuery(this).css('background-color')!=''&&jQuery(this).css('background-color')!='transparent'){jQuery(this).addClass('tm-bgcolor-yes')}
...
themetechmount_sticky()});jQuery(document).ready(function(){"use strict";themetechmount_isotope();tm_stretched_col();tm_stretched_col_calc();tm_bgimage_class();tm_bgcolor_class();tm_tabbox_class();setTimeout(function(){themetechmount_carousel()},100)})